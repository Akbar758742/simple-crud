...
<body>
    <div class="container ">
        <div class="flex justify-between">
            <h1 class=" text-red-500 font-extrabold">Edit-{{$ourPost->name}}</h1>
        ...
        <div class="">
            <form action="{{route('update',$ourPost->id)}}" method="post" enctype="multipart/form-data" >
                ...
                <div class="flex flex-col gap-3  ">
                    ...
                    <input type="text" name="name" class=" border" value="{{$ourPost->name}}">
                    @error('name')
                    ...
                    <input type="text" name="description" class=" border" value="{{$ourPost->description}}">
                    @error('description')
                    <p class=" text-red-600 ">{{$message}}</p>
